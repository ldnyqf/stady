...
function serachKeyword(sort,pageNum){
	window.location.href = "/search?keyword=" + $("#keyword").val()+"&sort="+sort+"&pageNum="+pageNum;
}
function fqBrand(brandId){
	window.location.href = "/search?keyword=${keyword}&qbrandId="+brandId+"&sort=${sort2}&pageNum=1&pa=${pa}&pb=${pb}";
}

function fqPrice(a,b){
	window.location.href = "/search?keyword=${keyword}&qbrandId=${brandId}&sort=${sort2}&pageNum=1&pa="+a+"&pb="+b;
}
